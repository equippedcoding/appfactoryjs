...
(function () {
	...
	function _upload(file, options) {
		...
		var chunkSize = 1024;//this.chunkSize;
	...
	function SocketIOFileClient(socket, options) {
		...
		this.accepts = [];
		this.maxFileSize = 5368709120;//undefined;
		this.socket = socket;
		this.uploadingFiles = {};
	...
	SocketIOFileClient.prototype.upload = function (fileEl, options) {
		...
		_upload.call(this, fileEl, options);
	...
	SocketIOFileClient.prototype.onComplete = function(callback){
		this.oncomplete();
	}
	SocketIOFileClient.prototype.setOnComplete = function(callback){
